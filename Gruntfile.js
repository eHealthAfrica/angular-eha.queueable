module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      scripts: {
        ...
        rename: function(dest, src) {
          return dest + src.replace('scripts','queueable');
        }
      }
    },
    concat: {
    ...
    uglify: {
      dist: {
        files: {
          'dist/queueable.template.min.js': ['.tmp/scripts.template.js'],
          'dist/queueable.min.js': ['.tmp/scripts.js']
        }
      }
    },
    html2js: {
